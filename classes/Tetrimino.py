	...
	def draw(self, game_display):
		...
		if self.shape == "I":
			if self.rotation == 0 or self.rotation == 180:
				# horizontal
				# block is		****
				game_display.fill(self.color, rect=[self.x, self.y, self.block_size, self.block_size])
				game_display.fill(self.color, rect=[self.x-self.block_size, self.y, self.block_size, self.block_size])
				game_display.fill(self.color, rect=[self.x+self.block_size, self.y, self.block_size, self.block_size])
				game_display.fill(self.color, rect=[self.x+2*self.block_size, self.y, self.block_size, self.block_size])
				...
				#           	*
				game_display.fill(self.color, rect=[self.x, self.y, self.block_size, self.block_size])
				game_display.fill(self.color, rect=[self.x, self.y-self.block_size, self.block_size, self.block_size])
				game_display.fill(self.color, rect=[self.x, self.y+self.block_size, self.block_size, self.block_size])
				game_display.fill(self.color, rect=[self.x, self.y+2*self.block_size, self.block_size, self.block_size])
			...
			game_display.fill(self.color, rect=[self.x, self.y+self.block_size, self.block_size, self.block_size])
			game_display.fill(self.color, rect=[self.x+self.block_size, self.y, self.block_size, self.block_size])
			game_display.fill(self.color, rect=[self.x+self.block_size, self.y+self.block_size, self.block_size, self.block_size])
